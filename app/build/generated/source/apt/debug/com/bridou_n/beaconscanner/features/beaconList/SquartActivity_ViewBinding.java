...
public class SquartActivity_ViewBinding<T extends SquartActivity> implements Unbinder {
  protected T target;

  private View view2131558531;

  @UiThread
  public SquartActivity_ViewBinding(final T target, View source) {
    this.target = target;

    View view;
    target.toolbar = Utils.findRequiredViewAsType(source, R.id.toolbar, "field 'toolbar'", Toolbar.class);
    target.rootView = Utils.findRequiredViewAsType(source, R.id.activity_squart, "field 'rootView'", CoordinatorLayout.class);
    ...
    target.textDfferent = Utils.findRequiredViewAsType(source, R.id.textDfferent, "field 'textDfferent'", TextView.class);
